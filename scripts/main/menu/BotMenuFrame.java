...
//
//    // TAB 1: Dashboard (CardLayout + a simple sidebar)
...
//
//        cardPanel.add(buildDashboardHome(), "HOME");
//        cardPanel.add(buildDashboardStats(), "STATS");
//        cardPanel.add(buildDashboardTasks(), "TASKS");
//
//        DefaultListModel<String> model = new DefaultListModel<>();
//        model.addElement("Home");
//        model.addElement("Stats");
//        model.addElement("Tasks");
//
//        JList<String> nav = new JList<>(model);
//        nav.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
//        nav.setSelectedIndex(0);
//        nav.setFixedCellHeight(36);
//        nav.setFont(new Font("Segoe UI", Font.PLAIN, 13));
//        nav.addListSelectionListener(e -> {
//            if (e.getValueIsAdjusting()) return;
//            switch (nav.getSelectedValue()) {
//                case "Home":
//                    cards.show(cardPanel, "HOME");
//                    break;
//
//                case "Stats":
//                    cards.show(cardPanel, "STATS");
//                    break;
//
//                case "Tasks":
...
//        navScroll.setPreferredSize(new Dimension(180, 0));
//
//        panel.add(navScroll, BorderLayout.WEST);
