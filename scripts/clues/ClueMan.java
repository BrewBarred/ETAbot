...
public abstract class ClueMan extends BotMan<ClueMenu> {
    ...
    public static boolean solveClue(String hint) {
...
//    }
    ...
    public ClueMan interpretClue() {
        ...
        // beginner map clue, 203 is all that is needed to determine beginner map
        //, {162,40} // TODO: test if this is emote clues
        //{203, 3}, {73, 3}, {73, 2}, {229, 1}, {229, 2} // mems ? med -> master?

        // fetch a list of all active widgets' root ids
        List<Integer> active = getWidgets().getActiveWidgetRoots();
        setStatus("Active: " + Arrays.toString(active.toArray()));
        // pass root ids to static map generator
        MapClue clue = MapClue.fromActiveWidgets(active);

        if (clue != null)
            setStatus("Hint: " + clue.getName());

        //TODO: implement something that writes clue hints to a file for me in the correct format so I can copy and paste them in to add them until no more exist.
